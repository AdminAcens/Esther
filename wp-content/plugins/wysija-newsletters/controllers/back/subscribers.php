...
class WYSIJA_control_back_subscribers extends WYSIJA_control_back{
    ...
    function main(){
         $this->messages['insert'][true]=__('Inscrição foi salva.',WYSIJA);
        $this->messages['insert'][false]=__('Inscrição não foi realizada.',WYSIJA);
        $this->messages['update'][true]=__('A inscrição foi modificada. [link]Edit again[/link].',WYSIJA);
        $this->messages['update'][false]=__('A inscrição não foi modificada.',WYSIJA);
