...
class WYSIJA_object{
    ...
    function getMsgs(){
        ...
        if(isset($wysija_msg['private']['error'])){
            $wysija_msg['error'][]=str_replace(array('[link]','[/link]'),array('<a class="showerrors" href="javascript:;">','</a>'),__('Um erro foi encontrado. [link]Mostrar mais detalhes.[/link]',WYSIJA));
        }

        if(isset($wysija_msg['private']['updated'])){
            $wysija_msg['updated'][]=str_replace(array('[link]','[/link]'),array('<a class="shownotices" href="javascript:;">','</a>'),__('[link]Mostrar mais detalhes.[/link]',WYSIJA));
        }
